...
void buildMaze(int xLength, int zWidth, char** mazeArray) {
...
//    // Save Removed Blocks
//    mcpp::Coordinate fixWorld;
//    mcpp::BlockType fixBlocks;
//    storeBlocks blockStorage;
